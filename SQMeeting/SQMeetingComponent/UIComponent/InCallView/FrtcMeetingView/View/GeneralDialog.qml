...
Window {
    ...
    property string titleText: "Title"         // 标题文字
    property string messageText: "Message"     // 消息内容
    property string leftButtonText: "Cancel"   // 左按钮文字
    property string rightButtonText: "Confirm" // 右按钮文字
    ...
    Rectangle {
        ...
        PopDialogBottomButton {
            ...
            btn_txt_unselected: leftButtonText//"保持静音"
            btn_txt_selected: leftButtonText//"保持静音"
        ...
        PopDialogBottomButton {
            ...
            btn_txt_font_pixelsize: 14
            btn_txt_unselected: rightButtonText//"打开麦克风"
            btn_txt_selected: rightButtonText//"打开麦克风"
